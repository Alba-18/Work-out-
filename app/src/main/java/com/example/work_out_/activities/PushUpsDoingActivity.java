...
public class PushUpsDoingActivity extends AppCompatActivity {
        ...
        int thisSetofPushUps = getIntent().getIntExtra("numberOfSets",0);
        ...
        protected void onCreate(Bundle savedInstanceState){
            ...
            View.OnClickListener actionButtonListener = v -> {
                ...
                if(number == thisSetofPushUps){
                    if(number == activities.getSets()[thisSetofPushUps]){
                        startActivity(new Intent(getApplicationContext(),FinishedExerciseActivity.class));
                    }
                    else{
                        Intent goToRest = new Intent(getApplicationContext(),RestActivity.class);
                        goToRest.putExtra("numberOfSets2",thisSetofPushUps+1);
                    }
                }

            };
            Button buttonDoPushup = findViewById(R.id.dopushup);
